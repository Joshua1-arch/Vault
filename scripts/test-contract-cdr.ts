...
async function main() {
  ...
  console.log("=== Deploying TimelockCondition Contract ===");
  ...
  console.log(`TimelockCondition successfully deployed at: ${timelockAddress}`);
  ...
  console.log("Allocating vault with TimelockCondition contract...");
  ...
  const secret = "secret payload under contract condition";
